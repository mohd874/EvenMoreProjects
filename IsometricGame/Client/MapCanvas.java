 ...
 * MapCanvas.java
 *
 * Created on November 2, 2003, 2:27 PM
 */
...
import IsometricGame.Map.IsometricMap;
...
public class MapCanvas {
   ...
   KeyListener {
	 ...
	 // Front Face
	 gl.glTexCoord2f(0.0f, 0.0f); gl.glVertex3f(-2.0f, -2.0f,  1.0f);
	 gl.glTexCoord2f(1.0f, 0.0f); gl.glVertex3f( 0.0f, -2.0f,  1.0f);
	 gl.glTexCoord2f(1.0f, 1.0f); gl.glVertex3f( 0.0f,  0.0f,  1.0f);
	 gl.glTexCoord2f(0.0f, 1.0f); gl.glVertex3f(-2.0f,  0.0f,  1.0f);
	/*// Back Face
	...
	gl.glTexCoord2f(0.0f, 1.0f); gl.glVertex3f(-1.0f,  1.0f, -1.0f);*/
	 ...
	 gl.glBindTexture(GL.GL_TEXTURE_2D, texture);
	 BufferedImage img = readImage("http://ucfpawn.homelinux.com/~pawn/NeHe.png");
	 ...
	 if (e.getKeyCode() == KeyEvent.VK_ESCAPE) {
      ...
      private BufferedImage readImage(String resourceName) {
	 try {
   ...
   public static void main(String args[]) {
      ...
      JFrame frame = new JFrame("Lesson 6: Texture Mapping");
      frame.setSize(800, 600);
      MapCanvas mc = new MapCanvas();
       frame.getContentPane().add(mc.canvas);
