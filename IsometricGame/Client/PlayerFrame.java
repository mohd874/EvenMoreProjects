 ...
 *
 * Created on July 7, 2003, 4:12 PM
 * Programmer:
 * Jason G
...
public class PlayerFrame extends javax.swing.JFrame {
    PlayerClient gameInstance;
    Hashtable tabNames;
    ImprovedObjectOutputStream tempDout;
    
    /** Creates new form MapPlayerStandalone */
    public PlayerFrame(Loader owner,ObjectInputStream din,ImprovedObjectOutputStream dout) {
        initComponents();
        ...
        gameInstance = new PlayerClient(this,gameWindow,sideBar,owner,tabNames,din,dout);
        this.show();
    }
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        actionsTab = new javax.swing.JPanel();
        ...
        gameWindow.setForeground(new java.awt.Color(255, 255, 255));
        ...
        sideBar.addTab("stats", statsTab);

        sideBar.addTab("Inventory", inventoryTab);

        sideBar.addTab("Actions", actionsTab);

        sideBar.addTab("Options", optionsTab);
    ...
    private javax.swing.JPanel actionsTab;
