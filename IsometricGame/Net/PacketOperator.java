...
public interface PacketOperator {
   ...
   //for client
   final byte ROOM_CREATED=-1,WALL_CREATED=-2,ITEM_CREATED=-3,ITEM_REMOVED_FROM_GROUND=-4,MAP_SENT=-5,ITEM_MOVED=-6,WALL_CHANGED=-7,AVATAR_CREATED=-8,AVATAR_MOVED=-9,
